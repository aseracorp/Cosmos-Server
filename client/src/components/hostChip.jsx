...
const probeRoute = async (route) => {
  ...
  try {
    ...
    // X-Cosmos-Container: sleeping (503) or running (200). Either way the
    // app is reachable - the header is authoritative, so never let the app's
    // own (possibly 404) HEAD response mark it offline.
